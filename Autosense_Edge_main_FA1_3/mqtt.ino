...
//Serial.println(topic);
  ...
  Serial.print("ss.encode");
  Serial.println(gps.encode(ss.read()));
  Serial.print("Sentence that failed checksum");
  Serial.println(gps.failedChecksum());
    Serial.print("Sentence that passed checksum");
  Serial.println(gps.passedChecksum());
  Serial.print("toatl number of charatcer proccessed");
